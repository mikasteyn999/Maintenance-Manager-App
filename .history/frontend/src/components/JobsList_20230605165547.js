    ...
    return (
      <div className='jobs-list'>
        ...
        <div className='batch-update'>
          <h3>Batch update selected jobs' statuses:</h3>
          <p>Tick the boxes of the jobs you want to change the status of, select the new status from the drop down box, and hit Batch Update</p>
