...
const JobsList = () => {
    ...
    //Test
    console.log(`Sending batch update request with jobIds: ${selectedJobs} and status: ${filterStatus}`);
...
const handleBatchUpdate = async () => {
  const status = document.getElementById('batchStatusUpdate').value;
  console.log(`Batch update status: ${status}`); // Add this line to log the status
